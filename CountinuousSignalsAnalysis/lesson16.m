...
NMPLV = abs(mean(exp(1i*NMDeltaPhase)));
...
% % making a loopin the phase bins
...
% normalizing the average amplitude of the
% gamma to obtain a probability
% "distribution", ie, a distribution that
% satisfies pj>=0 and sum pj = 1   
...
%% alternative way of programming, with less filtering
...
%% alternative way of programming 2, with less filtering
